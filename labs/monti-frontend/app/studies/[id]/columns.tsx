...
import QuestionaireSheet from "@/components/questionaireSheet"
            ...
            return (
                <div className="flex flex-row gap-2">
                    ...
                    <QuestionaireSheet
                        ...
                        // participantQuestionaires={row.original.questionaires}
                        participantQuestionaires={[]}
                        triggerLabel={"Fragebögen"}
                    />
                    {/* </Button> */}
